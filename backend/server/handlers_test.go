...
func TestCrud(t *testing.T) {
	...
	//EditList
	testData = strings.NewReader(testlist)
	req, err = http.NewRequest("PUT", "/api/todolist/task/0", testData)
	...
	//SuccessList
	testData = strings.NewReader(testlist)
	req, err = http.NewRequest("PUT", "/api/todolist/task/complete/0", testData)
	w = httptest.NewRecorder()
	...
	//DeleteList
	req, err = http.NewRequest("DELETE", "/api/todolist/task/0", nil)
	w = httptest.NewRecorder()
